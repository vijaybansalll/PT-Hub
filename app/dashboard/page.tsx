    ...
    <div className="min-h-screen bg-[#fafafa] text-zinc-900 font-sans antialiased pb-12 selection:bg-zinc-900 selection:text-white">
      ...
      <header className="border-b border-zinc-200 bg-white/95 backdrop-blur-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="hidden sm:flex items-center gap-2 px-3 py-1.5 rounded-full bg-zinc-100/80 text-zinc-650 border border-zinc-200/50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <Button
            ...
            className="inline-flex items-center justify-center rounded-lg text-sm font-semibold bg-zinc-900 text-white shadow-sm hover:bg-zinc-800 h-9 px-4 py-2 transition-all hover:scale-[1.01] active:scale-[0.99] cursor-pointer">
          ...
          <Combobox
            ...
            <div className="relative w-full md:w-72">
              ...
              <ComboboxInput
                ...
                className="w-full pl-9 h-9 placeholder:text-zinc-400 focus-visible:ring-1 focus-visible:ring-zinc-950 border border-zinc-200 rounded-lg bg-white text-sm"
                showTrigger={false}
              />
                  ...
                  {products
                    ...
                    .map((product) => (
                      <ComboboxItem
                        key={product.id}
                        value={product.name}
                        className="cursor-pointer text-zinc-700 hover:bg-zinc-50 py-1.5 px-3 text-xs">
                        {product.name}
                      </ComboboxItem>
                    ))}
                  {products.filter(
                    ...
                    <ComboboxEmpty className="py-2 text-center text-zinc-400 text-xs">
          ...
          {isLoading ? (
            ...
            <div className="py-16 text-center">
              ...
              <Button
                ...
                className="text-xs text-zinc-900 font-semibold cursor-pointer">
                Clear all filters
              </Button>
            </div>
          ) : (
            <>
              ...
              <div className="hidden sm:block">
                <Table>
                  <TableHeader>
                    <TableRow className="border-b border-zinc-200 hover:bg-transparent text-[11px] font-bold text-zinc-500 bg-zinc-55/10">
                      <TableHead className="h-10 px-6 align-middle text-left font-semibold text-zinc-500">
                        Product Details
                      </TableHead>
                      <TableHead className="h-10 px-6 align-middle text-left font-semibold text-zinc-500 hidden md:table-cell">
                        Category
                      </TableHead>
                      <TableHead className="h-10 px-6 align-middle text-right font-semibold text-zinc-500">
                        Price
                      </TableHead>
                      <TableHead className="h-10 px-6 align-middle text-left font-semibold text-zinc-500 hidden lg:table-cell">
                        Rating
                      </TableHead>
                      <TableHead className="h-10 px-6 align-middle text-left font-semibold text-zinc-500 hidden xl:table-cell">
                        Status
                      </TableHead>
                      <TableHead className="h-10 px-6 align-middle text-center font-semibold text-zinc-500">
                        Actions
                      </TableHead>
                    </TableRow>
                  </TableHeader>
                  <TableBody className="divide-y divide-zinc-100 text-zinc-650">
                    {filteredProducts.map((product) => (
                      <TableRow
                        key={product.id}
                        className="border-b border-zinc-200 transition-colors hover:bg-zinc-50/40">
                        <TableCell className="px-6 py-4 align-middle whitespace-normal">
                          <div>
                            <div className="font-bold text-zinc-900 leading-normal">
                              {product.name}
                            </div>
                        ...
                        <TableCell className="px-6 py-4 align-middle hidden md:table-cell">
                          <Badge
                            variant="secondary"
                            className="px-2 py-0.5 text-[11px] font-semibold text-zinc-600 bg-zinc-100 border border-zinc-200 h-auto rounded-md">
                            {product.category}
                          </Badge>
                        </TableCell>
                        ...
                        <TableCell className="px-6 py-4 align-middle">
                          <div className="flex items-center justify-center gap-2">
                            <Button
                              ...
                              title="Edit Product"
                              className="text-zinc-500 hover:text-zinc-900 hover:bg-zinc-50 cursor-pointer h-8 w-8 p-0">
                            ...
                            <Button
                              ...
                              className="text-zinc-500 hover:text-red-650 hover:bg-red-55 cursor-pointer h-8 w-8 p-0">
                  ...
                  <div
                    ...
                    <div className="flex justify-between items-start gap-2 mb-2">
                      <div>
                        ...
                        <Badge
                          variant="secondary"
                          className="px-2 py-0.5 mt-1 rounded-md text-[10px] font-semibold bg-zinc-100 border border-zinc-200/50 text-zinc-600 h-auto">
                          {product.category}
                        </Badge>
                      </div>
                    ...
                    <div className="flex flex-col gap-3 pt-3 border-t border-zinc-100 mt-2">
                      <div className="flex flex-wrap items-center gap-2">
                        <div className="flex items-center gap-0.5 text-zinc-700 text-xs font-bold bg-zinc-55 border border-zinc-200 px-2 py-0.5 rounded">
                      ...
                      <div className="flex items-center gap-2 w-full pt-1">
                        <Button
                          ...
                          size="sm"
                          onClick={() => handleOpenEditModal(product)}
                          className="flex-1 text-zinc-655 hover:text-zinc-900 hover:bg-zinc-50 h-8 text-xs font-semibold cursor-pointer border border-zinc-200">
      ...
      <Dialog open={isFormModalOpen} onOpenChange={setIsFormModalOpen}>
        <DialogContent className="max-w-lg bg-white border border-zinc-200 shadow-lg text-zinc-950 p-0 overflow-hidden flex flex-col max-h-[90vh] w-[calc(100%-2rem)] gap-0">
          <DialogHeader className="px-4 sm:px-6 pt-5 sm:pt-6 pb-4 flex flex-col space-y-1.5 relative border-b border-zinc-100">
          ...
          <form
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="flex w-full rounded-md border border-zinc-200 bg-white px-3 py-2 text-sm shadow-sm transition-colors placeholder:text-zinc-400 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-950 resize-none"></textarea>
              </div>
            ...
            <DialogFooter className="pt-4 border-t border-zinc-150 flex flex-col-reverse sm:flex-row justify-end gap-2 p-0 -mx-0 -mb-0 bg-transparent border-t-0 mt-8">
              <button
                type="button"
                onClick={() => setIsFormModalOpen(false)}
                className="w-full inline-flex items-center justify-center rounded-md text-xs font-semibold border border-zinc-200 bg-white hover:bg-zinc-50 h-8 px-4 transition-colors cursor-pointer">
                Cancel
              </button>
              <button
                type="submit"
                className="w-full inline-flex items-center justify-center rounded-md text-xs font-semibold bg-zinc-900 text-white hover:bg-zinc-800 h-8 px-4 transition-colors cursor-pointer shadow-sm">
      ...
      <Dialog
        ...
        <DialogContent
          className="max-w-sm bg-white border border-zinc-200 p-4 sm:p-5 shadow-lg text-zinc-950 w-[calc(100%-2rem)]"
